          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="text-black h5">Tienda en Línea</h2></div>
                <div class="d-flex">
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                      ...
                      <a class="dropdown-item" href="#">De la A a Z</a>
                      <a class="dropdown-item" href="#">De la Z a A</a>
            ...
            <div class="row mb-5">
              <?php
                ...
                $resultado = $conexion ->query("select * from productos order by id ASC") or die($conexion -> error);
                ...
                <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                  <div class="block-4 text-center border">
                      <figure class="block-4-image">
                        ...
                        <img src="img/product/<?php echo $fila['imagen'];?>" alt="<?php echo $fila['nombre'];?>" class="img-fluid"></a>
                      </figure>
                    <div class="block-4-text p-4">
                      <h3 class="text-shop"><a href="shop-single.php?id=<?php echo $fila['id'];?>"><?php echo $fila['nombre'];?></a></h3>
                      <p class="mb-0"><?php echo $fila['descripcion'];?></p>
                      <p class="mb-0">Talla: <?php echo $fila['talla'];?></p>
                      <p class="mb-0">Color: <?php echo $fila['color'];?></p>
                      <p class="text-price font-weight-bold">$ <?php echo $fila['precio'];?></p>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-3 order-1 mb-5 mb-md-0">
            <div class="border p-4 rounded mb-4">
              ...
              <ul class="list-unstyled mb-0">
                <li class="mb-1"><a href="#" class="d-flex"><span>Juvenil</span> <span class="text-black ml-auto">(2,220)</span></a></li>
                <li class="mb-1"><a href="#" class="d-flex"><span>Accesorios</span> <span class="text-black ml-auto">(550)</span></a></li>
                <li class="mb-1"><a href="#" class="d-flex"><span>Bolsas</span> <span class="text-black ml-auto">(280)</span></a></li>
                <li class="mb-1"><a href="#" class="d-flex"><span>Cosméticos</span> <span class="text-black ml-auto">(1,200)</span></a></li>
              </ul>
            </div>
            ...
            <div class="border p-4 rounded mb-4">
              ...
              <div class="mb-4">
                ...
                <label for="s_sm" class="d-flex">
                  <input type="checkbox" id="s_sm" class="mr-2 mt-1"> <span class="text-black">XCH </span>
                </label>
                <label for="s_md" class="d-flex">
                  <input type="checkbox" id="s_md" class="mr-2 mt-1"> <span class="text-black">CH </span>
                </label>
                <label for="s_lg" class="d-flex">
                  <input type="checkbox" id="s_lg" class="mr-2 mt-1"> <span class="text-black">M </span>
                </label>
                <label for="s_lg" class="d-flex">
                  <input type="checkbox" id="s_lg" class="mr-2 mt-1"> <span class="text-black">G </span>
                </label>
                <label for="s_lg" class="d-flex">
                  <input type="checkbox" id="s_lg" class="mr-2 mt-1"> <span class="text-black">XG </span>
                </label>
              </div>

              <div class="mb-4">
                <h3 class="mb-3 h6 text-uppercase text-black d-block">Colores</h3>
                ...
                <a href="#" class="d-flex color-item align-items-center" >
                  <span class="bg-warning color d-inline-block rounded-circle mr-2"></span> <span class="text-black">Amarillo (1,075)</span>
                </a>
              </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-7">
                <div class="footer__about">
                    ...
                    <p>Martina Boutique es una idea de negocio que surge como respuesta a la vanidad de las mujeres por vestir a la moda, de calidad y a buen precio.</p>
